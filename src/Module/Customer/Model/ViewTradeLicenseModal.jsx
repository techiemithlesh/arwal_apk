    ...
    <View style={sharedStyles.overlay}>
      <View style={sharedStyles.modalContent}>
        <ScrollView nestedScrollEnabled>
          ...
          <Text style={sharedStyles.mainTitle}>
            Municipal Trade Licence Approval Certificate
          </Text>

          <Text style={sharedStyles.mainTitle}>Municipal License</Text>

          <Text style={sharedStyles.subTitle}>RANCHI MUNICIPAL CORPORATION</Text>
          <Text style={sharedStyles.tinyText}>
          ...
          {[
            ...
            <View style={sharedStyles.rowContainer} key={index}>
              <Text style={sharedStyles.label}>{label}</Text>
              <Text style={sharedStyles.value}>{value}</Text>
            </View>
          ))}

          <Text style={sharedStyles.declaration}>
          ...
          <View style={{ marginTop: 10 }}>
            {[
              ...
              <Text style={sharedStyles.term} key={i}>
                {term}
              </Text>
            ))}
          </View>
          ...
          <TouchableOpacity style={sharedStyles.printBtn}>
            <Text style={sharedStyles.printText}>Print</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
    </View>
...
export default ViewTradeLicenseModal;
